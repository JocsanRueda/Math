...
class Scene9(Scene):
    def construct(self):
        ...
        square7 = square1.copy().next_to(square6, RIGHT, buff=0.5)
        square8 = square1.copy().next_to(square7, RIGHT, buff=0.5)
        box1 = VGroup(
        ...
        text1 = MathTex(r"4+0+0+0").next_to(circles, DOWN, buff=0.8).scale(0.6)
        self.play(
        ...
        box4 = box3.copy()
        text2 = MathTex(r"3+1").next_to(text1, DOWN, buff=0.8).scale(0.6)
        self.play(
        ...
        box5 = box4.copy()
        text3 = MathTex(r"2+2").next_to(text2, DOWN, buff=0.8).scale(0.6)
        self.play(
        ...
        box6 = box5.copy()
        text4 = MathTex(r"2+1+1").next_to(text3, DOWN, buff=0.8).scale(0.6)
        self.play(
        ...
        text5 = MathTex(r"1+1+1+1").next_to(text4, DOWN, buff=0.8).scale(0.6)
        self.play(
